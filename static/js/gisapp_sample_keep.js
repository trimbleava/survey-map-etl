...
function map_init_basic(map, options) {
    ...
    // [18, -130], [50, -64]);
    // var bounds = {"_southWest":{"lat":-14.2767,"lng":-177.36},"_northEast":{"lat":70.4114,"lng":167.7361}}
    // var bounds = L.latLngBounds([-14.276666999681481, -177.35999999959984],[70.41141700009547, 167.73611500030813]);
    ...
    var img = L.tileLayer('http://services.arcgisonline.com/arcgis/rest/services/World_Imagery/MapServer/MapServer/tile/{z}/{y}/{x}', {
        attribution: '|ESRI',
        maxZoom: 10,
        minZoom: 2,
        subdomains: 'a'
    ...
    var stamen =  L.tileLayer('//{s}.tile.stamen.com/toner-lite/{z}/{x}/{y}.png', {
